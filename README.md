...
1) Главная страница index.html:
	...
	- новинки;
2) Страница "О нас";
3) Страница "Контакты с информацией для связи с магазином";
4) Страница товаров, отображающая все товары в магазине (весь ассортимент);
5) Страница поиска:
	- поиск по всем полям;
	- сообщение об отсутствии результатов поиска;
6) Панель администратора с CRUD операциями над таблицами (Create, Read, Update, Delete):
